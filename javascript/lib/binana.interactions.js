...
export {_flexibility, HYDROPHOBIC_DIST_CUTOFF, METAL_COORDINATION_CUTOFF, HYDROGEN_HALOGEN_BOND_ANGLE_CUTOFF, _ligand_atom_types, default_params, HYDROGEN_HALOGEN_BOND_DIST_CUTOFF, _pi_pi, _hydrophobics, _cat_pi, ACTIVE_SITE_FLEXIBILITY_DIST_CUTOFF, _metal_coordination, _salt_bridges, CATION_PI_DIST_CUTOFF, T_STACKING_ANGLE_TOLERANCE, _set_default, _electrostatic_energies, CLOSE_CONTACTS_DIST2_CUTOFF, _close, _hydrogen_halogen_bonds, PI_STACKING_ANGLE_TOLERANCE, PI_PADDING_DIST, PI_PI_INTERACTING_DIST_CUTOFF, T_STACKING_CLOSEST_DIST_CUTOFF, SALT_BRIDGE_DIST_CUTOFF, ELECTROSTATIC_DIST_CUTOFF, CLOSE_CONTACTS_DIST1_CUTOFF, _closest};
...
export var get_all_interactions = function (ligand, receptor, closest_dist_cutoff, close_dist_cutoff, electrostatic_dist_cutoff, active_site_flexibility_dist_cutoff, hydrophobic_dist_cutoff, hydrogen_halogen_bond_dist_cutoff, hydrogen_halogen_bond_angle_cutoff, pi_pi_general_dist_cutoff, pi_stacking_angle_tol, t_stacking_angle_tol, t_stacking_closest_dist_cutoff, cation_pi_dist_cutoff, salt_bridge_dist_cutoff, metal_coordination_dist_cutoff, pi_padding) {
	...
	if (typeof hydrogen_halogen_bond_dist_cutoff == 'undefined' || (hydrogen_halogen_bond_dist_cutoff != null && hydrogen_halogen_bond_dist_cutoff.hasOwnProperty ("__kwargtrans__"))) {;
		var hydrogen_halogen_bond_dist_cutoff = null;
	};
	...
	var hydrogen_halogen_bond_dist_cutoff = _set_default (hydrogen_halogen_bond_dist_cutoff, HYDROGEN_HALOGEN_BOND_DIST_CUTOFF);
	...
	var hydrogen_bonds = get_hydrogen_or_halogen_bonds (ligand, receptor, hydrogen_halogen_bond_dist_cutoff, hydrogen_halogen_bond_angle_cutoff, true);
	var halogen_bonds = get_hydrogen_or_halogen_bonds (ligand, receptor, hydrogen_halogen_bond_dist_cutoff, hydrogen_halogen_bond_angle_cutoff, false);
