...
export var write_all = function (ligand, receptor, all_interactions, log_output, as_str, pdb_filename) {
	...
	var as_str = _set_default (as_str, false);
	var pdb_filename = _set_default (pdb_filename, 'results.pdb');
	return write (ligand, receptor, all_interactions ['closest'], all_interactions ['close'], all_interactions ['hydrophobics'], all_interactions ['hydrogen_bonds'], all_interactions ['halogen_bonds'], all_interactions ['salt_bridges'], all_interactions ['metal_coordinations'], all_interactions ['pi_pi'], all_interactions ['cat_pi'], all_interactions ['active_site_flexibility'], log_output, as_str, pdb_filename);
};
