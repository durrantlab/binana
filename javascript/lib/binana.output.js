...
export {_directory, pdb_file, dictionary, _json, _openFile, _log};
...
export var _write_main = function (parameters, ligand, receptor, closest, close, hydrophobics, hydrogen_bonds, halogen_bonds, salt_bridges, pi_pi, cat_pi, electrostatic_energies, active_site_flexibility, ligand_atom_types) {
	...
	var log_output = binana.output._log.collect (parameters, ligand, closest, close, hydrophobics, hydrogen_bonds, halogen_bonds, salt_bridges, pi_pi, cat_pi, electrostatic_energies, active_site_flexibility, ligand_atom_types, json_output);
	...
	if (parameters.params ['output_file'] != '') {
		binana.output.pdb_file.write (ligand, receptor, closest, close, hydrophobics, hydrogen_bonds, halogen_bonds, salt_bridges, pi_pi, cat_pi, active_site_flexibility, log_output, false, parameters.params ['output_file']);
	}
	if (parameters.params ['output_dir'] != '') {
		_directory.make_directory_output (parameters, closest, close, active_site_flexibility, hydrophobics, hydrogen_bonds, halogen_bonds, pi_pi, cat_pi, salt_bridges, ligand, receptor);
	}
};
