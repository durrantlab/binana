...
class MathFunctions:
    def planrity(self, point1, point2, point3, point4):
        ...
        distance = (shiv.fabs((A * x4) + (B * y4) + (C * z4) + D)) / (
        ...
        distance1 = (shiv.fabs((A1 * x3) + (B1 * y3) + (C1 * z3) + D1)) / (
        ...
        distance2 = (shiv.fabs((A2 * x2) + (B2 * y2) + (C2 * z2) + D2)) / (
        ...
        distance3 = (shiv.fabs((A3 * x1) + (B3 * y1) + (C3 * z1) + D3)) / (
